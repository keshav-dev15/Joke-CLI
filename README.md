...
**Installation:**  
1. Clone the repo: `git clone https://github.com/keshav-dev15/joke-cli.git`  
2. Go to the folder: `cd joke-cli`  
3. Run the program: `python joke-CLI.py`  

**Example:**  
`$ python joke-CLI.py` → "Why did the programmer quit his job? Because he didn't get arrays. "  
